...
function gtp_cuisine_edit_form_fields($term)
{
    ...
    <tr class="form-field">
        ...
        <td>
            <input type="text" name="gtp_more_info_url" value="<?php echo $url ?>" />
            <p class="description"><?php _e('A URL a user can click to learn more information about this cuisine', 'gothemify-plus')?></p>
        </td>
    </tr>
    <?php
}
