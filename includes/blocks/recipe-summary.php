...
function gt_recipe_summary_render_cb($atts, $content, $block)
{
    ...
    ob_start();
    ?>
        <div class="wp-block-gothemify-plus-recipe-summary">
            <i class="bi bi-alarm"></i>
            <div class="recipe-columns-2">
                <div class="recipe-metadata">
                <div class="recipe-title">
                    <?php _e('Prep Time', 'gothemify-plus');?>
                </div>
                ...
                <div class="recipe-metadata">
                <div class="recipe-title">
                    <?php _e('Cook Time', 'gothemify-plus');?>
                </div>
